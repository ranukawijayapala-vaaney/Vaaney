...
export class ObjectStorageService {
  ...
  async getObjectReadURL(objectPath: string): Promise<string> {
    // Get the object file
    const objectFile = await this.getObjectEntityFile(objectPath);
    
    // Get bucket and object name from the file
    const bucketName = objectFile.bucket.name;
    const objectName = objectFile.name;
    
    // Generate signed URL for reading (GET)
  ...
  normalizeObjectEntityPath(rawPath: string): string {
    ...
    // Handle HTTPS URLs from Google Cloud Storage
    ...
    // Handle raw bucket paths (e.g., /replit-objstore-xxx/.private/uploads/...)
